...
import ImgOne from '../../assets/gzh_two.jpg'
    ...
    const cardList = [
        {
            img:ImgOne,
            title:'什么是摩托车交强险',
            desc:'摩托车交强险是国家强制购买的。没有交强险是不能上路的因为摩托车和汽车都是机动车，所以一样需要买交强险，交强险是指当被保险的摩托车发生道路交通事故造成他人的人身伤亡、财产损失时，保险公司给予对方赔偿，不保障自己车辆和人身损失。其次，交强险财产损失最高赔付两千。'
        },
        {
            img:LogoSvg,
            title:'什么是摩托车三者险',
            desc:'摩托车三者险也叫第三方责任险，是赔对方的。翻译成大白话，意思就是你自己或者你的朋友驾驶你的摩托车，发生交通事故并造成人员伤亡或者财产损失，这个时候三者险将会赔偿交强险赔付后剩余的金额。（例子:某天小明骑摩托车不小心和一辆汽车发生刮擦，汽车修理费为5万。交强险最多只能赔付2千，是远远不够的，如果买了三者险，那么三者险将会继续赔付剩余的4.8万'
        },
        {
            img:ImgFive,
            title:'什么是盗抢险',
            desc:'摩托车盗抢险，摩托车盗抢险是指全车被盗窃以及在被盗窃期间受到损坏或车上零部件、附属设备丢失需要修复的合理费用。在规定时间内车辆未找回，赔偿车辆受益人裸车价+购置税。'
        }
    ]
    let _drawList = ()=>{
