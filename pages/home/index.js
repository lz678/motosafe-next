...
import MTInput from '../../src/common/components/MTInput/MTInput'
import MTNetwork from "../../src/network/MTNetwork";
import {useDispatch, useSelector} from 'react-redux'
import mainAction from '../../src/redux/action/mainAction'
import backgroundTwo from '../../src/assets/moto_two.jpg'
        ...
        <>
            <div className={Style.home_box} id='home_box_id'>
                <div className={Style.left_content}>
                    {/*<img src={backgroundTwo.src} alt="" loading='lazy'/>*/}
                    <Image src={backgroundTwo} alt='摩托车保险' loading='lazy' width={500}/>
                </div>
